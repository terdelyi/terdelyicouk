    ...
    <article class="mb-10">
        ...
        <div class="md:flex gap-8">
            <div class="hidden md:block w-1/3">
                <img src="<?php echo asset('pages/talk1.jpg') ?>"
                     alt="PHP + Static = Phanstatic at PHPSW"
                     loading="eager"
                     class="rounded-lg shadow-md">
            </div>
            <div class="md:w-2/3">
                <div class="mb-1 font-semibold text-primary dark:text-content/60 tracking-tight">July 2024</div>
