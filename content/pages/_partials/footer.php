        ...
        <footer class="dark:text-content/50 <?php if ($page->permalink !== '/') : ?>bg-black/5 text-body/70 dark:bg-none dark:border-t dark:border-white/10 py-5<?php else: ?>text-body/60 py-10<?php endif; ?>">
