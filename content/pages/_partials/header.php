...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=inter:400,600,700,800|roboto:400,500,600" rel="stylesheet" />
        ...
        <header class="relative font-title <?php if ($page->permalink !== '/') : ?>bg-secondary/95 dark:border-b dark:border-white/10 text-content dark:text-grey-400<?php else : ?>border-b border-body/10 dark:border-0<?php endif; ?>">
            <div class="w-full flex items-center justify-between mx-auto h-16 md:max-w-screen-lg">
                ...
                <div class="flex sm:hidden mr-4">
                    ...
                    <button id="mobile-menu-hide" class="hover:text-opacity-70 dark:hover:text-content hidden">
                        <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div id="mobile-menu" class="max-w-screen-md sm:hidden px-4 md:px-0 pb-4 mx-auto dark:bg-secondary hidden">
                <ul>
                    ...
                    <li class="pb-1"><a href="/talks/" class="hover:underline<?php if ($page->is('/talks/')) :?> font-bold text-white<?php endif; ?>">Talks</a></li>
                    <li class="pb-1"><a href="/contact/" class="hover:underline<?php if ($page->is('/contact/')) :?> font-bold text-white<?php endif; ?>">Contact</a></li>
