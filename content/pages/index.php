...
<div class="max-w-screen-lg m-auto">
    <div class="w-full sm:max-w-screen-lg lg:py-0 m-auto flex items-center text-center lg:text-left">
        <div class="w-full mb-0 lg:w-3/5">
            <div class="whitespace-pre-line mb-2 px-4 sm:px-0 text-5xl tracking-tight text-blue-600 dark:text-grey-400 font-extrabold">I'm a Software Developer</div>
            <div class="whitespace-pre-line mb-10 px-10 sm:px-0 text-blue-600 dark:text-grey-400 text-3xl leading-tight tracking-tight">with <span class="font-extrabold text-pink"><?php echo $experienceInYears; ?> years of full-stack experience</span>
                based in Gloucestershire, UK</div>
            <div class="text-xl/8 pl-8 pr-8 lg:pl-0 lg:pr-8">
