<template>
  <footer>
    <div class="max-w-screen-lg mx-auto text-center text-xs text-grey mb-10">
      <ul class="inline-flex mb-6">
          <li>
          ...
          <li>
            <a href="https://twitter.com/iamterdelyi" target="_blank" rel="noopener noreferrer" class="mx-2 hover:text-pink" aria-label="Twitter">
