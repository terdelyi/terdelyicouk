<template>
  <Layout>
    ...
    <div class="font-display mb-4 leading-relaxed font-thin">If you have a question, an exciting project idea or job opportunity just fill me in with the details in case I might be interested. I try to reply all emails in a couple days.</div>
